    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-stone-50 to-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-800">Our Family Tree</h1>
          <p className="text-stone-500 text-sm mt-1">Kassim Pillai Family</p>
        </div>

        <Card className="shadow-xl border-0">
          <CardHeader className="pb-2">
            <CardTitle>Welcome back</CardTitle>
            <CardDescription>Sign in to access the family tree</CardDescription>
          </CardHeader>
        ...
        <p className="text-center text-xs text-stone-400 mt-6">
          This is a private family website. Unauthorized access is prohibited.
        </p>
      </div>
    </div>
  );
